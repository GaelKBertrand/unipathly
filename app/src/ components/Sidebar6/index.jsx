...
export default function Sidebar6({ ...props }) {
  ...
  return (
    <Sidebar
      ...
      className={`${props.className} flex flex-col h-screen pt-5 gap-4 top-0 border-blue_gray-400_c6 border-solid bg-white-a700 !sticky overflow-auto`}
    >
      <Menu
        menuItemStyles={{
          button: {
      ...
      >
        <div className="flex flex-col gap-[0.90px]">
